...
DEFAULT_CONFIG = {
    ...
    "label_template": [
        {"type": "text", "text": "{name}", "x_mm": 0, "y_mm": 0.8, "w_mm": 40,
         "size": 30, "bold": True, "italic": False, "align": "center"},
        {"type": "line", "x_mm": 1, "y_mm": 5.6, "w_mm": 38, "size": 2},
        {"type": "text", "text": "НЕТТО: {net_kg} кг", "x_mm": 1.5, "y_mm": 6.6,
         "w_mm": 17, "size": 15, "bold": True, "italic": False, "align": "left"},
        {"type": "text", "text": "БРУТТО: {gross_kg} кг", "x_mm": 1.5, "y_mm": 9.6,
         "w_mm": 17, "size": 15, "bold": True, "italic": False, "align": "left"},
        {"type": "text", "text": "{company_name}", "x_mm": 19.5, "y_mm": 6.2,
         "w_mm": 19, "size": 11, "bold": True, "italic": False, "align": "left"},
        {"type": "text", "text": "{company_address}", "x_mm": 19.5, "y_mm": 8.0,
         "w_mm": 19, "size": 11, "bold": True, "italic": False, "align": "left"},
        {"type": "text", "text": "{company_inn}", "x_mm": 19.5, "y_mm": 9.8,
         "w_mm": 19, "size": 11, "bold": True, "italic": False, "align": "left"},
        {"type": "text", "text": "{company_phone}", "x_mm": 19.5, "y_mm": 11.6,
         "w_mm": 19, "size": 11, "bold": True, "italic": False, "align": "left"},
        {"type": "line", "x_mm": 1, "y_mm": 13.6, "w_mm": 38, "size": 2},
        {"type": "barcode", "x_mm": 1.5, "y_mm": 14.4, "w_mm": 37, "size": 11},
        {"type": "line", "x_mm": 1, "y_mm": 25.8, "w_mm": 38, "size": 2},
        {"type": "text", "text": "Изгот.: {prod_date}   Годен до: {exp_date}",
         "x_mm": 1.5, "y_mm": 26.6, "w_mm": 37, "size": 14, "bold": True,
